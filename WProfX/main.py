        ...
        for _site in _sites:
            ...
            for run_no in range(repeat_no):
                ...
                try:
                    ...
                    _node_cmd = ['/home/zhaoxin/.nvm/versions/node/v8.9.4/bin/node', '/home/zhaoxin/workspace/YPTN/WProfX/chrome_launcher.js', _site,  _trace_file, _summary_file, _screenshot_file]
